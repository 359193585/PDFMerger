# **English** · [中文](https://github.com/359193585/PDFMerger/edit/main/README.zh-CN.md)
...
> 👉 [Download Now (GitHub Releases)](https://github.com/359193585/PDFMerger/releases)  
> 👉 [Domestic Mirror Download (Gitee Releases)](https://gitee.com/leison01010101/PDFMerger/releases)  
...
- **Bookmark Retention and Enhancement​**​:  
  - Take the **​​source file name**​​ as the first-level bookmark directory  
  - If the source file already has bookmarks, retain the bookmark hierarchy after merging and automatically downgrade them to child nodes (for quick positioning).
...
2. Main Interface:
   - Click ​​"Add Files"​​ or directly drag PDF/IMG files into the window.
...
Note: For ultra-large PDF files, when the interface indicates that the merge is complete but the Cancel Merge button is still clickable, the output file may not have finished being written to the disk. Please wait patiently for the output file to be fully saved to the disk.

# 📦 Download and Installation
## Pre-compiled Packages
- Go to the Releases page to download the compressed package suitable for your system:

  - PDFMerger.1.0.0.win-x64.zip – Windows 64-bit
  - PDFMerger.1.0.0.win-x64-bundled.zip – Windows 64-bit self-contained runtime version
  - PDFMerger.1.0.0.macos-x64.app.tar.gz – macOS Intel
  - PDFMerger.1.0.0.macos-arm64.app.tar.gz – macOS Apple Silicon
  - PDFMerger.1.0.0.linux-x64.tar.gz – Linux 64-bit
  - PDFMerger.1.0.0.linux-x64-bundled.tar.gz – Linux 64-bit self-contained runtime version
  - PDFMerger.1.0.0.linux-arm64.tar.gz – Linux ARM64 (trusted computing devices)
  - PDFMerger.1.0.0.linux-arm64-bundled.tar.gz – Linux ARM64 (trusted computing devices) self-contained runtime version
